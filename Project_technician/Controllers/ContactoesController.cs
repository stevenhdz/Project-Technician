...
namespace Project_technician.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdContact,Name,Mail,Phone,Mensaje")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdContact,Name,Mail,Phone,Mensaje")] Contacto contacto)
        {
            if (id != contacto.IdContact)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ContactoExists(contacto.IdContact))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Contacto.Any(e => e.IdContact == id);
        }
    }
}
